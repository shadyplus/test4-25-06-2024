...
function initGoogleApi() {
    let addressInputs = document.querySelectorAll('.al-address');
...
(function () {
    let apiKey = 'AIzaSyDZuRUsRBeVLHdwlXgWUHVBo4vwQYZVVEg';
    let script = document.createElement('script');
    script.src = 'https://maps.googleapis.com/maps/api/js?key=' + apiKey + '&libraries=places&loading=async&callback=initGoogleApi';
    script.defer = true;
    script.async = true;
    script.id = 'googleAPI';
